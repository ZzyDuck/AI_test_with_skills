...
| Snapshot       | `await page.screenshot({ path: 'playwright-output/screenshots/TC-XXXX.png', fullPage: true })` |

**Snapshot Pattern (MANDATORY for each test case):**

Every test case MUST include a screenshot capture at the end of the test to document the page state:
...
- Use the test case ID as filename: `TC-XXXX.png`
- Example: `TC-0001.png`, `TC-0038.png`, `TC-0041.png`
